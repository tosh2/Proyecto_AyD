...
var SysforumMisTemasComponent = /** @class */ (function () {
    function SysforumMisTemasComponent(temaServicio) {
        var _this = this;
    ...
    SysforumMisTemasComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.usuario = "kLSIR8yuTvSR7qCcmoRy";
        this.temaServicio.getTemasUsuario(this.usuario).subscribe(function (temas) {
            _this.temas = temas;
        });
    };
    SysforumMisTemasComponent = __decorate([
        Component({
    ...
    return SysforumMisTemasComponent;
}());
export { SysforumMisTemasComponent };
//# sourceMappingURL=sysforum-mis-temas.component.js.map